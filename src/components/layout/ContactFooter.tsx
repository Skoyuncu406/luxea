 ...
 * =============================================================
 *
 * Gerçek firma bilgileri geldiğinde yalnızca bu sabitleri
...
/*
 * Gerçek adres geldiğinde değiştirilecek.
 */
const ADDRESS = {
...
/*
 * Gerçek sosyal medya URL'leri geldiğinde
 * href değerlerini değiştirmemiz yeterli.
 */
const SOCIAL_LINKS = [
  {
    id: "instagram",
...
export default function ContactFooter({
  ...
  className="
    ...
    hover:bg-accent
    hover:!text-white
    hover:shadow-[0_18px_45px_rgba(146,115,74,0.22)]
  "
>
  <Phone
    size={15}
                  ...
                  ({
                    ...
                    <Link
                      ...
                      className="
                        ...
                        hover:bg-accent
                        hover:text-white
                        hover:shadow-[0_12px_30px_rgba(146,115,74,0.18)]
                      "
                    >
                      <span
                        aria-hidden="true"
 ...
 * SVG kullanıyoruz.
 *
 * Böylece lucide-react sürümündeki sosyal medya icon export
 * değişikliklerinden etkilenmiyoruz.
 * =============================================================
 */
